...
export default function DownloadSalesLogCSV({ data = [], storeName = 'My Store' }) {
  ...
  const generateCSV = () => {
    const headers = ['Date', 'Purchased By', 'Item', 'Qty', 'Amount'];
    const metaHeader = [`Store: ${storeName}`, `Generated: ${new Date().toLocaleString()}`];
